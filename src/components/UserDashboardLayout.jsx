          ...
          items={[
            {
              ...
              label: (
                <Link to="/dashboard" style={{ color: 'inherit', textDecoration: 'none', fontWeight: 500 }}>
                  Overview
                </Link>
              ),
            },
            ...
            },
            {
              ...
              label: (
                <Link to="/dashboard/tickets" style={{ color: 'inherit', textDecoration: 'none', fontWeight: 500 }}>
                  My Tickets
                </Link>
              ),
            },
